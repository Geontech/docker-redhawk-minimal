...
from DockerComponent_base import *

class DockerComponent_i(DockerComponent_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", DockerComponent_i.MyMsg, self.msg_callback)
            ...
            msg_out = DockerComponent_i.MyMsg()
    ...
    Accessing the Device Manager and Domain Manager:
        ...
        # DO STUFF...other than copy the data buffer, like here.
        outData = packet.dataBuffer[:]
...
if __name__ == '__main__':
    ...
    start_component(DockerComponent_i)
